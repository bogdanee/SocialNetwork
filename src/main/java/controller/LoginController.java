...
public class LoginController {
    ...
    public void handleLogin() throws Exception {
        ...
        else
        {
            ...
            users.add(1);
            users.add(2);
            Event event1 = new Event(1, 1,"Gratar1", "fain", LocalDateTime.now(), users, "");
            Event event2 = new Event(1, 1,"Gratar2", "fain", LocalDateTime.now(), users, "");
            Event event3 = new Event(1, 1,"Gratar3", "fain", LocalDateTime.now(), users, "");
